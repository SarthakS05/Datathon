...
// Restaurant-specific wrapper with sample data for an Asian fusion restaurant
const RestaurantExpenseReport = () => {
  const quickActions: QuickAction[] = [
    { icon: Library, title: 'Order Ingredients', description: 'Place wholesale orders' },
    { icon: Search, title: 'Log Delivery', description: 'Record incoming shipment' },
    { icon: ChevronRight, title: 'Add Menu Item', description: 'Create a new dish' },
    { icon: ChevronRight, title: 'Close Day', description: 'Finalize daily totals' },
  ];

  const recentActivity: Activity[] = [
    { icon: <Library className="w-5 h-5" />, title: 'Gochujang (20kg) Purchase', time: '2h ago', amount: -320.0 },
    { icon: <Library className="w-5 h-5" />, title: 'Fresh Fish Delivery', time: '5h ago', amount: -540.0 },
    { icon: <History className="w-5 h-5" />, title: 'Dinner Service', time: '8h ago', amount: 1840.5 },
    { icon: <History className="w-5 h-5" />, title: 'Lunch Service', time: '1d ago', amount: 920.75 },
  ];

  const financialServices: Service[] = [
    { icon: Library, title: 'Local Vendor - SeaFresh', description: 'Daily fish supplier', isPremium: true, hasAction: true },
    { icon: Library, title: 'Spice Importers Co.', description: 'Korean & Japanese sauces', hasAction: false },
  ];
